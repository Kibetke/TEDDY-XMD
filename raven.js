...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/254799963583?text=Hello+Teddy+dev+I+need+a+bot',
                                mediaType: 1,
    ...
    if (data.status && data.result) {
      ...
      await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗",
        },
        { quoted: m }
      );
        ...
        async function redeployApp() {
            try {
                const response = await axios.post(
                    ...
                    {
                        source_blob: {
                            url: "https://github.com/Teddytech1/TEDDY-XMD/tarball/main",
                        },
                    },
                    {
                        headers: {
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY TEDDY-XMD`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	      case 'ice': {		      
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Ice Teddy");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'snow': {	      
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Snow Teddy");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'impressive': {		      
		     if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "impressive Teddy");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'typography': {   
		          if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Typography Teddy");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'thunder':{		       
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Teddy Tech");
      return;
    }
	try {
...
//========================================================================================================================//		      
	case 'leaves': {		     
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves TEDDY-XMD");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case '1917': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "1917 Teddy");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena TEDDY-XMD");
      return;
    }
	try {
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝗧𝗲𝗱𝗱𝘆 𝘅𝗺𝗱 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗧𝗲𝗱𝗱𝘆 𝘅𝗺𝗱, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
...
if (!text) return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 Teddy xmd 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
if (!/image|pdf/.test(mime)) return m.reply("That is not an image, try again while quoting an actual image.");             
                    ...
                    m.reply(`𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗧𝗲𝗱𝗱𝘆[𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 ${mime.includes("pdf") ? "𝗣𝗗𝗙" : "𝗜𝗺𝗮𝗴𝗲"} . . .`);
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    return;
  }
  ;
  let _0x44b3e0;
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗧𝗲𝗱𝗱𝘆-𝘅𝗺𝗱'}, { quoted: m })
			}
			break;
...
//========================================================================================================================//		      
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝗛𝗶 𝗶𝗺 𝗧𝗲𝗱𝗱𝘆👋, 𝗜 𝗮𝗺 𝗔𝗹𝗶𝘃𝗲 𝗻𝗼𝘄",
          body: "𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗",
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
let fta = await uploadToCatbox(fdr)
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗧𝗲𝗱𝗱𝘆 𝘅𝗺𝗱 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗧𝗲𝗱𝗱𝘆 𝘅𝗺𝗱 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗧𝗘𝗗𝗗𝗧-𝗫𝗠𝗗:*\n\n';  
...
try {
        ...
        const capp = `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗`;
...
` Hello👋 *${pushname}*,You can deploy 𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗 using the GitHub link below 𓅂\n\nFork and give us a star✨.\n\n https://github.com/Teddytech1/TEDDY-XMD\n\nLink with your whatsapp using pairing link below\n\nhttps://teddy-xmd-session.onrender.com/pair\n\nCopy the session_id and paste it on the SESSION string, Fill in the other required Variables before Deploy\n\nEnjoy and have fun with ░𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗░\n\n𝗠𝗮𝗱𝗲 𝗯𝘆 𝗧𝗲𝗱𝗱𝘆 @+254799963583!`},{quoted : m });
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗧𝗲𝗱𝗱𝘆-𝘅𝗺𝗱 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
                ...
                client.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗',
                            body: 'https://github.com/Teddytech1/TEDDY-XMD',
