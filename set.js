...
const botname = process.env.BOTNAME || '𝗧𝗘𝗗𝗗𝗬-𝗫𝗠𝗗';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'𝗕𝗢𝗧';
const packname = process.env.STICKER_PACKNAME || '𝗧𝗘𝗗𝗗𝗬';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '254799963583';
const menulink = process.env.MENU_LINK || 'https://files.catbox.moe/8v1o4d.jpg';
